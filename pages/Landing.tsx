    ...
    <div className="flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 relative z-10">
          <div className="md:w-2/3">
            ...
            <p className="text-xl text-green-50 mb-10 max-w-2xl leading-relaxed">
              Experience the passion of football like never before. Stream live
              matches, create content, connect with your followers, and explore
              the beauty of the Kingdom through sports.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            to="/streams"
            className="text-saudi-green font-medium hover:text-saudi-dark flex items-center"
          >
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="animate-pulse bg-gray-200 dark:bg-gray-800 h-64 rounded-xl"
              ></div>
            ))}
          </div>
        ) : (
                ...
                <Link key={stream.id} to={`/streams/${stream.id}`}>
                  ...
                  >
                    ...
                    <div className="px-4 pb-4">
                      <p className="text-xs text-saudi-green/80 font-medium">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
              Your Tournament Companion
            </h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Everything you need to follow the action, right from your pocket.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Real-time match data, player tracking, and instant replays from
                every angle.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Never miss a kick-off. Filter by your favorite teams and venues
                like Riyadh and Neom.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Go live yourself. Share your reactions, analyze games, and build
                your own fanbase.
              </p>
            </div>
          </div>
